...
if __name__ == '__main__':
    # price_df = DL.loadDB('tpc_df.csv', parse_dates=['Date', 'Time'])
    price_df = DL.loadDB('price_df.csv', parse_dates=['Date', 'Time'])

    tpc_df = price_df[price_df['Report Type'] == 'Target Price Change'].copy().reset_index(drop=True)
    non_tpc_df = price_df[price_df['Report Type'] == 'Target Price Change'].copy().reset_index(drop=True)
