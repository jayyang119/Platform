...
class Dataset:
    ...
    def _drop_entries_with_non_tradable_location(self, mode='stable'):
        """
    ...
    def _add_updated_ticker_col(self):
        ...
        """
        ticker_change_df = pd.read_csv(f'{CODE_PATH}/library/data/ticker_symbol_change.csv')
    ...
    def _add_entry_date_col(self):
        ...
        """
        f = open(os.path.join(CODE_PATH, 'library/data/ticker_to_trading_days.json'))
        data = json.load(f)
        f.close()
    ...
    def _add_fx_rate_col(self):
        ...
        """
        f = open(os.path.join(CODE_PATH, 'library/data/fx_rates.json'))
        data = json.load(f)
        f.close()
    ...
    def clean(self, tz_name='Asia/Hong_Kong', mode='stable'):
        ...
        self._drop_entries_with_non_tradable_location(mode=mode)  # Need input countries
...
if __name__ == '__main__':
    try:
        ...
        df = pd.read_csv(os.path.join(CODE_PATH, 'library/data/bofa_test.csv'))
        data = Dataset(df)
        ...
        data.add_market_data(path=os.path.join(CODE_PATH, 'library/data/bofa_mkt_data.json'))
