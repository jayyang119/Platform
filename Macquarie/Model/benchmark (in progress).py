...
from Backtest.settings import (benchmark_expectancy, hit_ratio, benchmark_side,
...
def benchmark_rules(by_x='exch_location', train_data=None, test_data=None):
    ...
    def get_all_trades_expectancy():
        ...
        expectancy_by_market_and_report_type = benchmark_expectancy(all_trades_train_data, column,
        ...
        expectancy_by_ticker = benchmark_expectancy(all_trades_train_data, column,
        ...
        expectancy_by_analyst = benchmark_expectancy(all_trades_train_data, column,
...
if __name__ == '__main__':
    ...
    def plot_matrix(strategy='Headline strategy (scoring on side, market, report type)'):
        ...
        for side in trade_df['side'].unique():
            ...
            for by_i in df[by].unique():
                logger.info(by_i)
                df_i = df[df[by] == by_i]
                k = benchmark_expectancy(df_i, column,
    ...
    def benchmark_strategy(sort_by='exch_region'):
        ...
        expectancy_sort_by = benchmark_expectancy(train_data, column,
